...
public class SekiroClient {
    private static SekiroClient sekiroClient;
    ...
    public void connect(String serverHost, int serverPort, String clientId, String group) {
        this.serverHost = serverHost;
        this.serverPort = serverPort;
        //@ 是一个hermes保留分隔符
    ...
    public void send(String msg) {
        if (getCmdChannel() != null) {
            new SekiroResponse(getCmdChannel()).success(msg);
        }
    }
